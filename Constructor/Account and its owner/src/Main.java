/**
 * There are two classes: Account with three fields (code, balance, owner) and User with three fields
 * (login, firstName, lastName). Both classes have parameterized constructors. See the full declarations of these
 * classes in the code template. Do not be afraid of the static keyword. It's not important now.
 *
