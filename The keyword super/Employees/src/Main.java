 ...
 *
 * Employee is the base class. It includes three fields (name, email and integer variable experience), one constructor
 * with three arguments and three getters: getName(), getEmail(), getExperience().
