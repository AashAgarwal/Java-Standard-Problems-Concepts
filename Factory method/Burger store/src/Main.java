...
class BurgerStore extends BurgerFactory {
    ...
    Burger createBurger(String type) {
        return switch (type) {
            case "Chinese Burger" -> new ChineseBurger("Chinese Burger");
            case "American Burger" -> new AmericanBurger("American Burger");
            case "Russian Burger" -> new RussianBurger("Russian Burger");
            default -> null;
        };
    }
}
