/**
 * Suppose you have a DriverNotReadyException class and class Driver:
 *
 * Your task is to write a drive() method which prints to the console the string Here we go if both arguments are true,
 * or otherwise throws the DriverNotReady exception with the message Close the door or fasten your seatbelt
 */
